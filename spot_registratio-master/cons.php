...
echo"<h3>THE CONSTELLATION FINALIST(TREASURE HUNT)</h3>";
echo"<h5>Contact: Dheekshika - 7598230926</h5><br>";
echo"<h5>Venue: IT Lab I</h5><br>";
...
$sql = "SELECT * FROM events where events like 'The%'";
